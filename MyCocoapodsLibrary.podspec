...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/joferava/MyCocoapodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'joferava' => 'jfelipe221095@gmail.com' }
  s.source           = { :git => 'https://github.com/joferava/MyCocoapodsLibrary.git', :tag => s.version.to_s }
